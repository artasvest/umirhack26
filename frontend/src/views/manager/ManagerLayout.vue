...
<template>
  <div class="page-shell">
    ...
    <header class="app-header hidden md:block">
      <div
        class="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8"
      >
        <nav class="flex flex-wrap items-center gap-2 sm:gap-1">
          <RouterLink
            to="/manager"
            ...
            active-class="!bg-accent/20 !text-ink-950 ring-1 ring-accent/35 dark:!text-ink-50"
          >
            Заявки
          </RouterLink>
          <RouterLink
        ...
        <div class="flex flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:gap-2">
          <button
            type="button"
            class="self-start rounded-full px-3 py-2 text-sm font-semibold text-ink-800 ring-1 ring-ink-200 transition hover:bg-ink-100 dark:text-ink-100 dark:ring-ink-600 dark:hover:bg-ink-800 sm:self-auto"
          ...
          <button
            type="button"
            class="self-start rounded-full px-3 py-2 text-sm font-medium text-ink-600 transition hover:bg-ink-100 hover:text-ink-950 dark:text-ink-400 dark:hover:bg-ink-800 dark:hover:text-white sm:self-auto"
            @click="logout"
          >
            Выйти
          </button>
